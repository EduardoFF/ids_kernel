...
from ipykernel.eventloops import _use_appnope
#from ipykernel.ipkernel import IPytonKernel
try:
...
class EchoKernel(KernelBase):
    ...
    def __init__(self, **kwargs):
        super(EchoKernel, self).__init__(**kwargs)
    ...
    def start(self):
        ...
        super(EchoKernel, self).start()

    def set_parent(self, ident, parent):
        """Overridden from parent to tell the display hook and output streams
        about the parent message.
        """
        super(EchoKernel, self).set_parent(ident, parent)
    ...
    def init_metadata(self, parent):
        ...
        """
        md = super(EchoKernel, self).init_metadata(parent)
